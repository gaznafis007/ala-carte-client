      ...
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-r from-purple-600 to-indigo-600">
          ...
          <div className="absolute inset-0 opacity-65">
            <Image src="https://images.unsplash.com/photo-1673993445820-bf5721697cfa?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Restaurant interior" fill className="object-cover" />
          </div>
